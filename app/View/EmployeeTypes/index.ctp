<div class="employeeTypes index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $employeeType['EmployeeType']['id']), null, __('Are you sure you want to delete # %s?', $employeeType['EmployeeType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
