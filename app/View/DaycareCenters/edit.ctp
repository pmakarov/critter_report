<div class="daycareCenters form">
<?php echo $this->Form->create('DaycareCenter'); ?>
	<fieldset>
		<legend><?php echo __('Edit Daycare Center'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DaycareCenter.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DaycareCenter.id'))); ?></li>
